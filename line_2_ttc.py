    ...
    def fetch_alerts(self):
        ...
        try:
            ...
            for block in alert_blocks:
                ...
                # 1. THE TIME CHECKER (Done once per block)
                if "active_period" in block:
                    is_active = False
                    
                    # Find all active periods in this block (handles newlines natively)
